...
export async function sendTactfulReminder(
    ...
    if (type === "proximo") {
        ...
        <div style="font-family: Arial, sans-serif; color: #333;">
          ...
          <p>Si ya lo tiene listo, le invitamos a subirlo en la plataforma cuando tenga la oportunidad. Si tiene algún inconveniente o duda, estamos a su disposición para apoyarle.</p>
      ...
      `;
        ...
        <div style="font-family: Arial, sans-serif; color: #333;">
          ...
          <p>Entendemos perfectamente que pueden surgir imprevistos o contratiempos en las actividades diarias. Le pedimos de la manera más atenta si pudiera subir su archivo a la plataforma a la brevedad posible, a fin de regularizar su expediente.</p>
